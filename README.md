...
一般代码、配置、较小模型可以直接提交。  
若单个文件超过约 50–100MB，GitHub 可能拒绝推送，可改用 [Git LFS](https://git-lfs.com)，或放到网盘并在 `voice_model/README.md` 写下载链接。
...
2. 按 `voice_model/README.md` 放置模型文件
3. 运行推理 / 联调脚本
